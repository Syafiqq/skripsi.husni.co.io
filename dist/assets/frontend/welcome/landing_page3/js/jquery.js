...
}("undefined" != typeof window ? window : undefined, function (a, b)
{
    ...
    m.fn = m.prototype = {
        jquery: l, constructor: m, selector: "", length: 0, toArray: function toArray()
        {
            return d.call(this);
        }, get: function get(a)
        {
    ...
    }, m.extend = m.fn.extend = function ()
    {
        var a,
            ...
            i = arguments.length,
            j = !1;
        for ("boolean" == typeof g && (j = g, g = arguments[h] || {}, h++), "object" == (typeof g === "undefined" ? "undefined" : _typeof(g)) || m.isFunction(g) || (g = {}), h === i && (g = this, h--); i > h; h++)
        {
        ...
        expando: "jQuery" + (l + Math.random()).replace(/\D/g, ""), isReady: !0, error: function error(a)
        {
            throw new Error(a);
        }, noop: function noop()
        {
    ...
    function Q(a, b, d, e)
    {
        if (m.acceptData(a))
        {
            ...
            {
                return k || (k = i ? a[h] = c.pop() || m.guid++ : h), j[k] || (j[k] = i ? {} : {toJSON: m.noop}), ("object" == (typeof b === "undefined" ? "undefined" : _typeof(b)) || "function" == typeof b) && (e ? j[k] = m.extend(j[k], b) : j[k].data = m.extend(j[k].data, b)), g = j[k], e || (g.data || (g.data = {}), g = g.data), void 0 !== d && (g[m.camelCase(b)] = d), "string" == typeof b ? (f = g[b], null == f && (f = g[m.camelCase(b)])) : f = g, f;
            }
        }
    }
    ...
    m.extend({
        ...
        style: function style(a, b, c, d)
        {
            if (a && 3 !== a.nodeType && 8 !== a.nodeType && a.style)
            {
                ...
                if (f = typeof c === "undefined" ? "undefined" : _typeof(c), "string" === f && (e = Qb.exec(c)) && (c = (e[1] + 1) * e[2] + parseFloat(m.css(a, b)), f = "number"), null != c && c === c && ("number" !== f || m.cssNumber[h] || (c += "px"), k.clearCloneStyle || "" !== c || 0 !== b.indexOf("background") || (i[b] = "inherit"), !(g && "set" in g && void 0 === (c = g.set(a, c, d)))))
                {
                    try
                    {
                        i[b] = c;
    ...
    m.Tween = Zb, Zb.prototype = {
        constructor: Zb, init: function init(a, b, c, d, e, f)
        {
    ...
    {
        var d = a && "object" == (typeof a === "undefined" ? "undefined" : _typeof(a)) ? m.extend({}, a) : {
    ...
    m.fn.extend({
        ...
        attr: function attr(a, b, c)
        {
            ...
            if (a && 3 !== f && 8 !== f && 2 !== f)
            {
                return _typeof(a.getAttribute) === K ? m.prop(a, b, c) : (1 === f && m.isXMLDoc(a) || (b = b.toLowerCase(), d = m.attrHooks[b] || (m.expr.match.bool.test(b) ? nc : mc)), void 0 === c ? d && "get" in d && null !== (e = d.get(a, b)) ? e : (e = m.find.attr(a, b), null == e ? void 0 : e) : null !== c ? d && "set" in d && void 0 !== (e = d.set(a, c, b)) ? e : (a.setAttribute(b, c + ""), c) : void m.removeAttr(a, b));
            }
            ...
            return {
                send: function send(c, d)
                {
                    ...
                    f.send(a.hasContent && a.data || null), _b3 = function b(c, e)
                    {
                        ...
                        {
                            if (delete Xc[g], _b3 = void 0, f.onreadystatechange = m.noop, e)
                            {
    ...
    m.fn.load = function (a, b, c)
    {
        ...
        var d,
            ...
            g = this,
            h = a.indexOf(" ");
        return h >= 0 && (d = m.trim(a.slice(h, a.length)), a = a.slice(0, h)), m.isFunction(b) ? (c = b, b = void 0) : b && "object" == (typeof b === "undefined" ? "undefined" : _typeof(b)) && (f = "POST"), g.length > 0 && m.ajax({
            url: a,
            type: f,
            dataType: "html",
            data: b
    ...
    m.offset = {
        ...
        offset: function offset(a)
        {
            ...
            if (f)
            {
                return b = f.documentElement, m.contains(b, e) ? (_typeof(e.getBoundingClientRect) !== K && (d = e.getBoundingClientRect()), c = dd(f), {
