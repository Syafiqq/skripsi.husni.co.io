        ...
        <div class="wrap">
            <header id="topnav">
                <nav>
                    <ul>
                        <li>
                            <a href="<?php echo site_url('dashboard') ?>" class="scroll">Halaman Depan</a>
                        </li>
                        <li>
        ...
        <div class="wrap">
            ...
            <div id="da-slider" class="da-slider">
                <div class="da-slide">
                    ...
                    <p>
                        <img width="" height="250" alt="" src="<?php echo base_url(); ?>assets/profil.jpg" style="float:center" class="">
                    </p>
                ...
                <div class="da-slide">
                    <h2>Pengembang Aplikasi</h2>
                    <p>Pengembang adalah Zazilah Intania Rahma, Lahir di Pasuruan , 23 Agustus tahun 1994. Pengembang merupakan aknak kedua dari pasangan Bapak Sukar Budi Leksono dan Ibu Endang Sujiati ini menempuh taman kanak-kanak di TK Muslimat NU Darun Naja Pagak, Kecamata Beji dan lulus pada tahun 2000. Pengembang melanjutkan pendidikan dasar selanjutnya di Sekolah Dasar Negeri Pagak, Kecamatan Beji hingga lulus pada tahun 2006.
                    </p>
                </div>

                <div class="da-slide">
                    <h2>Pengembang Aplikasi</h2>
                    <p>Sekolah Menengah Pertama yang ditempuh pengembang adalah SMP Negeri 1 Bangil, Kecamatan Bangil hingga tahun 2009. Selanjutnya, Pengembang melanjutkan Sekolah Menengah atas di SMA Negeeri 1 Bangil dan berhasil lulus pada tahun 2012. Pendidikan Tinggi yang ditempuh pengembang adalah Program Studi Bimbingan dan Konseling di Universitas Negeri Malang melalui jalur masuk SNMPTN Undangan pada tahun 2012.</p>
                </div>
