...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/frontend/auth/login/bootstrap/css/bootstrap.min.css')?>">
...
<!-- Javascript -->
<script src="<?php echo base_url('assets/frontend/auth/login/js/jquery-1.11.1.min.js')?>"></script>
<script src="<?php echo base_url('assets/frontend/auth/login/bootstrap/js/bootstrap.min.js')?>"></script>
<script src="<?php echo base_url('assets/frontend/auth/login/js/jquery.backstretch.min.js')?>"></script>
<script src="<?php echo base_url('assets/frontend/auth/login/js/scripts.js')?>"></script>
