            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <div class="box-body">
                            <p> Ketika kamu tidak bisa mengekspresikan atau menceritakan emosimu, menulis bisa menjadi salah satu cara yang bisa kamu lakukan </p>
                            <p> Ceritakan lebih lengkap lagi pengalamanmu sesuai dengan skor yang paling tinggi !!! </p>
                        </div>
                        <!-- /.box-body -->
                    </div>
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Kisah-Kisahku</h3>
                        </div>
                        <!-- /.box-header -->
                        ...
                        if (isset($storiesMetadata) && (!empty($storiesMetadata)))
                        {
                            ...
                            echo '<th style="width: 220px">Penilaian</th>';
                            echo '<th style="width: 20px">Status</th>';
                            echo '<th style="width: 40px">Lengkapi Kisah</th>';
                            echo '</tr>';
